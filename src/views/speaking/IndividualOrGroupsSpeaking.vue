        ...
        <div class="d-flex justify-content-center align-items-center flex-wrap">
          <div class="card shadow  bg-body-tertiary rounded" style="max-width: 28rem;">
            ...
            <div class="card-footer d-flex justify-content-center ">
              ...
              <router-link to="/individual_speaking" id="btn" class="btn btn-primary">Begin <i
          ...
          <div class="card shadow  bg-body-tertiary rounded" style="width: 28rem;">
            ...
            <div class="card-footer d-flex justify-content-center">
              ...
              <router-link to="/group_speaking" class="btn btn-primary">Begin <i class="fa fa-arrow-right-long"></i>
              </router-link>
